...
function buildImageViewer(selectedImage, imageList) {
	...
	$.each(imageList, function(index) {
		...
		var navigationDot = $("<img src=\"/static/archive/img/navigation_dot.gif\" width=\"8\" height=\"8\">");
...
function setupImageViewers() {
	...
	buildImageViewers([
		[".kaleidoscope-1", "/static/archive/img/software/kaleidoscope/1-big.jpg"],
		[".kaleidoscope-2", "/static/archive/img/software/kaleidoscope/2-big.jpg"],
		[".kaleidoscope-3", "/static/archive/img/software/kaleidoscope/3-big.jpg"],
		[".kaleidoscope-4", "/static/archive/img/software/kaleidoscope/4-big.jpg"]]);

	buildImageViewers([
		[".versions-1", "/static/archive/img/software/versions/1-big.jpg"],
		[".versions-2", "/static/archive/img/software/versions/2-big.jpg"],
		[".versions-3", "/static/archive/img/software/versions/3-big.jpg"],
		[".versions-4", "/static/archive/img/software/versions/4-big.jpg"]]);

	buildImageViewers([
		[".checkout-1", "/static/archive/img/software/checkout/1-big.jpg"],
		[".checkout-2", "/static/archive/img/software/checkout/2-big.jpg"],
		[".checkout-3", "/static/archive/img/software/checkout/3-big.jpg"],
		[".checkout-4", "/static/archive/img/software/checkout/4-big.jpg"]]);

	buildImageViewers([
		[".enstore-1", "/static/archive/img/software/enstore/1-big.jpg"],
		[".enstore-2", "/static/archive/img/software/enstore/2-big.jpg"],
		[".enstore-3", "/static/archive/img/software/enstore/3-big.jpg"],
		[".enstore-4", "/static/archive/img/software/enstore/4-big.jpg"]]);
