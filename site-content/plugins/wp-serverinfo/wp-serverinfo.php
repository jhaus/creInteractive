...
function serverinfo_menu() {
	if (function_exists('add_submenu_page')) {
		add_submenu_page('index.php',  __('WP-ServerInfo', 'wp-serverinfo'),  __('WP-ServerInfo', 'wp-serverinfo'), 'manage_options', 'wp-serverinfo/wp-serverinfo.php', 'display_serverinfo');
	}
}
